	...
	public class AuthController : Controller
	{
		...
		public IActionResult Forgot(string email)
		{
			...
			else
			{
				...
				string message = "A request has been generated to reset your password. Please <b><a href=\"https://localhost:7231/Auth/ChangePassword?token=" + token + "&email=" + email +"\">Click here</a></b> to reset your password.";
